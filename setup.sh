...
sudo wget -O /boot/grml/grml.iso download.grml.org/grml64-full_2022.11.iso
sudo bash -c "echo 'CUSTOM_BOOTOPTIONS=\"ssh=pas123 vnc=pas123 dns=8.8.8.8,8.8.4.4 netscript=raw.githubusercontent.com/lamtota40/onworks/main/ngrok.sh startx toram\"' >> /etc/default/grml-rescueboot"
